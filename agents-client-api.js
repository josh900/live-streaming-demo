...
async function handleAvatarChange() {
  ...
  const idleVideoElement = document.getElementById('idle-video-element');
  const idleVideoElement = document.getElementById('idle-video-element');
if (avatars[currentAvatar].voiceSpeed) {
  currentVoiceSpeed = avatars[currentAvatar].voiceSpeed;
  document.getElementById('voice-speed-slider').value = currentVoiceSpeed;
  document.getElementById('voice-speed-value').textContent = `${currentVoiceSpeed}x`;
}
  if (idleVideoElement) {
  if (idleVideoElement) {
  if (idleVideoElement) {
...
async function saveAvatar() {
  ...
  formData.append('voiceId', voiceId);
  formData.append('voiceId', voiceId);
formData.append('voiceSpeed', currentVoiceSpeed);
  if (imageFile) {
  if (imageFile) {
  if (imageFile) {
  if (imageFile) {
